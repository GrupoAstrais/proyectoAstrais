...
const initialProfile: ProfileState = {
  ...
  name: "Astra",
  username: "astra",
  description: "Mascota oficial de Astraïs.",
  level: 3,
  xp: 45,
  ...
  return (
    <article className={`${surfaceCardClassName} ${className}`}>
      <header className="mb-4">
        ...
        <h2 className="font-['Press_Start_2P'] text-base leading-6 sm:text-lg">
          {title}
        </h2>
      </header>
      {children}
    ...
    <div className="flex items-center justify-between gap-4 rounded-2xl border border-white/10 bg-white/10 px-4 py-4">
      ...
      <button
        ...
        className={`relative h-8 w-15 rounded-full border transition-colors duration-200 ${
          checked
            ? "border-accent-mint-300 bg-accent-mint-400/80"
...
export default function Profile() {
  ...
  const handleSaveProfile = (event: FormEvent<HTMLFormElement>) => {
    ...
    if (!cleanedName || !cleanedUsername) {
      setStatusMessage(
        "Necesitas un nombre y un username validos para guardar el perfil.",
      );
      return;
    }
    ...
    >
      ...
      <section className="grid gap-4 px-4 py-6">
        <div className="grid grid-cols-1 gap-4 xl:grid-cols-5">
            ...
            <div className="relative flex flex-col gap-6">
              <header className="flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
                <div>
                  ...
                  <h1 className="font-['Press_Start_2P'] text-xl leading-7 sm:text-2xl">
                    {profile.name}
                  </h1>
                      ...
                      icon={
                        ...
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M16.86 3.49a2.1 2.1 0 012.97 2.97L8 18.29 3 20l1.71-5L16.86 3.49z"
                          />
                        </svg>
                      }
                    />
                      ...
                      icon={
                        ...
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M10.33 2.2l.31 1.86a7.96 7.96 0 012.72 0l.31-1.86 2.53.74-.62 1.8c.82.43 1.57 1 2.2 1.64l1.7-.74 1.27 2.3-1.49 1.1c.17.47.3.96.38 1.47l1.9.3v2.6l-1.9.3a8.24 8.24 0 01-.38 1.47l1.49 1.1-1.27 2.3-1.7-.74a8.05 8.05 0 01-2.2 1.64l.62 1.8-2.53.74-.31-1.86a7.96 7.96 0 01-2.72 0l-.31 1.86-2.53-.74.62-1.8a8.05 8.05 0 01-2.2-1.64l-1.7.74-1.27-2.3 1.49-1.1a8.24 8.24 0 01-.38-1.47L2.2 13.3v-2.6l1.9-.3c.08-.51.21-1 .38-1.47L2.99 7.83l1.27-2.3 1.7.74a8.05 8.05 0 012.2-1.64l-.62-1.8 2.53-.74z"
                          />
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                      ...
                      icon={
                        ...
                        >
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M16 11a4 4 0 10-4-4 4 4 0 004 4zM8 13a3 3 0 10-3-3 3 3 0 003 3z"
                          />
                          <path
                            strokeLinecap="round"
                            strokeLinejoin="round"
                            d="M16 13c3.31 0 6 1.57 6 3.5V18H10v-1.5c0-1.93 2.69-3.5 6-3.5zM8 14c1.5 0 2.85.32 3.85.85"
                          />
                        </svg>
                      }
                    />
          ...
          <div className="grid grid-cols-1 col-span-2 gap-4 sm:grid-cols-2 xl:grid-cols-1">
              ...
              <div className="flex flex-col gap-3">
                <div className="rounded-2xl border border-white/10 bg-black/20 px-4 py-3">
                  ...
                  <p className="mt-1 text-sm text-white/70">
                    {visibilityDescription[settings.visibility]}
                  </p>
                </div>
            ...
            {settings.showAchievements ? (
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-1 gap-3 sm:grid-cols-2">
                  <div className="rounded-2xl border border-white/10 bg-black/20 px-4 py-4">
                    <p className="font-semibold text-white">
                      Constelacion ordenada
                    </p>
                    <p className="mt-2 text-sm text-white/70">
                      Completa una semana seguida de tareas diarias.
                    </p>
                  </div>
                  <div className="rounded-2xl border border-white/10 bg-black/20 px-4 py-4">
                    <p className="font-semibold text-white">
                    ...
                    <p className="mt-2 text-sm text-white/70">
                      Participa activamente en tres grupos distintos.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="rounded-2xl border border-dashed border-white/15 bg-black/20 px-4 py-8 text-center">
                <p className="font-semibold text-white">
                  Tus logros estan ocultos en este momento.
                </p>
                <p className="mt-2 text-sm text-white/70">
                  Vuelve a activarlos desde ajustes si quieres mostrarlos en tu
                  perfil publico.
                </p>
                <button
                  type="button"
            ...
            <div className="space-y-3">
              {profileFriends.slice(0, 3).map((friend) => (
                ...
                >
                  ...
                  <div className="flex items-center gap-3">
                    <span
                      className={`rounded-full px-3 py-1 text-xs ${getFriendStatusClassName(friend.status)}`}
                    >
                      {friend.status}
                    </span>
          ...
          <div className="rounded-2xl border border-white/10 bg-black/20 px-4 py-4 lg:col-span-2">
            ...
            <p className="mt-3 text-sm leading-6 text-white/80">
              {draftProfile.description ||
                "Tu descripcion aparecera aqui cuando empieces a escribir."}
            </p>
          </div>
        </form>
      </ProfileModal>
      ...
      >
        ...
        >
          <div className="space-y-3">
            <p className="text-sm font-semibold uppercase tracking-[0.08em] text-(--astrais-rarity-epic)">
              Privacidad
            </p>
          ...
          <div className="space-y-3">
            ...
            <p className="text-sm text-white/70">
              Si te registraste con Google, aqui puedes definir email y
              contrasena para iniciar sesion tambien con credenciales.
            </p>
            <label className="flex flex-col gap-2">
      ...
      >
        <div className="space-y-4">
          ...
          <div className="rounded-2xl border border-white/10 bg-black/20 px-4 py-4">
            <p className="text-sm font-semibold text-white">
              Vista previa del texto compartido
            </p>
        ...
        <div className="space-y-3">
          {profileFriends.map((friend) => (
            ...
            >
              ...
              <span
                className={`w-fit rounded-full px-3 py-1 text-sm ${getFriendStatusClassName(friend.status)}`}
              >
                {friend.status}
              </span>
            </div>
